		...
		wrapper_clicked: function(e)
		{
			...
			$('body').unbind().on('click', '.day_id-' + $(this).attr('id'), function () {
				if($(this).html() != "&nbsp;"){
					...
					var a = $('<a />').addClass('notShown').html('<em>' + tmpArr[0] + '</em><i></i>').hide().appendTo(selectElement.children('div'));
					a.slideDown(400, function () {
						setTimeout(function () {
							a.addClass('shown');
							selectElement.children('div').children('span').addClass('hide');
							selectElement.find('option:contains(' + tmpArr[0] + ')').prop('selected', true);
						}, 500);
					});
